            ...
            <div>
                @if(!empty($referer))
                    <a class="btn btn-warning" href="{{ $referer }}">
                        ...
                        <span>{{ trans('uploader::main.back') }}</span>
                    </a>
                @endif
                ...
                href="{{ route('uploader_file_list_manager') . (!empty($fromFileSetter) ? '?from_file_setter=1' : '') }}">
                    ...
                    <span>{{ trans('uploader::main.list') }}</span>
                </a>
                @if($manager != 'file_edit')
                    ...
                    href="{{ route('uploader_file_upload_manager') . (!empty($fromFileSetter) ? '?from_file_setter=1' : '') }}">
                        ...
                        <span>{{ trans('uploader::main.uploader') }}</span>
                    </a>
                @endif
            </div>
            @if($manager == 'file_upload')
                <div>
                    <button class="btn btn-success" onclick="newUploadBlock()">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-square" viewBox="0 0 16 16">
                            <path d="M14 1a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1zM2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2z"/>
                            <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4"/>
                        </svg>
                        <span>{{ trans('uploader::main.new') }}</span>
                    </button>
                    <button class="btn btn-primary" onclick="groupUpload()">
                    ...
                    <button class="btn btn-warning" onclick="cancelAllUploadBlocks()">
