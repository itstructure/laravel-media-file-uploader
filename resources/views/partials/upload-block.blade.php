<div role="upload-block" class="upload-block">
    ...
    <div class="preview-block">
        ...
        <div role="file_preview" class="file-preview">{{ trans('uploader::main.thumbnail') }}</div>
    </div>
    ...
    <form role="upload-form" class="upload-form" onsubmit="submitUploadForm(event)">
        ...
        <div class="input-group mb-2">
            ...
            <input type="text" role="alt" name="data[alt]" class="form-control" placeholder="{{ trans('uploader::main.alt') }}" aria-label="{{ trans('uploader::main.alt') }}">
        ...
        <div class="input-group mb-2">
            ...
            <input type="text" role="title" name="data[title]" class="form-control" placeholder="{{ trans('uploader::main.title') }}" aria-label="{{ trans('uploader::main.title') }}">
        ...
        <div class="input-group mb-2">
            ...
            <textarea role="description" name="data[description]" class="form-control" aria-label="{{ trans('uploader::main.description') }}"></textarea>
        ...
        <div class="input-group mb-2 file-section">
            ...
            <div class="input-group-append">
                <button class="btn btn-primary ml-1" type="submit">
                    ...
                    <span>{{ trans('uploader::main.upload') }}</span>
                </button>
                <button class="btn btn-warning ml-1 through" type="button" onclick="cancelUploadBlock(event)">
                    ...
                    <span>{{ trans('uploader::main.cancel') }}</span>
                </button>
            </div>
